...
Route::get('/import', [ListingsController::class, 'importCsv'])->middleware('auth');

Route::post('/importfile', [ListingsController::class, 'importFile'])->name('importfile')->middleware('auth');
